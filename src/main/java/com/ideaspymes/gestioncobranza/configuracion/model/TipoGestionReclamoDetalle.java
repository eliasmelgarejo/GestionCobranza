 ...
 */
@Entity
public class TipoGestionReclamoDetalle implements Serializable, IAuditable {
    private static final long serialVersionUID = 1L;
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Long id;
    @Listado(descripcion = "Descripción corta",mostrar = true)
    private String descripcionCorta;
    @Listado(descripcion = "Descripción larga",mostrar = true)
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof TipoGestionReclamoDetalle)) {
            return false;
        }
        TipoGestionReclamoDetalle other = (TipoGestionReclamoDetalle) object;
