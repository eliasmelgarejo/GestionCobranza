 ...
 */
@Entity
public class Tramo implements Serializable, IAuditable {
    private static final long serialVersionUID = 1L;
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Long id;
    @Listado(descripcion = "Incio",mostrar=true)
    private Integer incio;
    @Listado(descripcion = "Fin",mostrar = true)
    private Integer fin;
    @Listado(descripcion = "Descripción",mostrar = true)
    ...
    public Integer getIncio() {
        return incio;
    }

    public void setIncio(Integer incio) {
        this.incio = incio;
    }
