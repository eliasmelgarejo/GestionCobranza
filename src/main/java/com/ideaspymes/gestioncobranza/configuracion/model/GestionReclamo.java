 ...
 */
@Entity
public class GestionReclamo implements Serializable, IAuditable {
    ...
    @OneToOne
    private Deuda deuda;
    @OneToMany(mappedBy = "gestionReclamo")
    private List<GestionReclamoDetalle> gestionReclamoDetalles;
    @ManyToOne
    ...
    public List<GestionReclamoDetalle> getGestionReclamoDetalles() {
        return gestionReclamoDetalles;
    }

    public void setGestionReclamoDetalles(List<GestionReclamoDetalle> gestionReclamoDetalles) {
        this.gestionReclamoDetalles = gestionReclamoDetalles;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof GestionReclamo)) {
            return false;
        }
        GestionReclamo other = (GestionReclamo) object;
